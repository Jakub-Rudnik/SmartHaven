...
-- Wstawienie urządzeń
INSERT INTO `Device` (`DeviceTypeID`, `DeviceName`, `Location`)
VALUES (1, 'klimatyzacja1', 'Salon'),
       (2, 'lampa1', 'Sypialnia'),
...
-- Klimatyzacja włączana codziennie o 8:00
...
VALUES (2, 1), -- user1 ma urządzenie 1
